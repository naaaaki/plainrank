  ...
  return (
    <main className="min-h-screen bg-white text-[#1E293B]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        {/* Plainrankを支援する */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-[#1E293B] mb-4">Plainrankを支援する</h2>
          <p className="text-gray-500 leading-relaxed mb-6">
            Plainrankは広告なし・スポンサーなしで運営しています。広告なしで運営するために、GitHubスポンサーで支援いただけると助かります。
          </p>
          <a
            href="https://github.com/sponsors/naaaaki"
            target="_blank"
            rel="noopener noreferrer"
